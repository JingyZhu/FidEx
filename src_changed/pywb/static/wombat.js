...
(function () {
  ...
  function autobind(clazz) {
    for (
      var prop,
        propValue,
        proto =
          clazz.__proto__ || clazz.constructor.prototype || clazz.prototype,
        clazzProps = Object.getOwnPropertyNames(proto),
        len = clazzProps.length,
        i = 0;
      i < len;
      i++
    )
  ...
  function Storage(wombat, type, initData) {
    if (ThrowExceptions.yes) throw new TypeError("Illegal constructor");
    if (initData && initData.length)
      for (var i = 0; i < initData.length; i++)
        this[initData[i][0]] = initData[i][1].toString();
    Object.defineProperty(this, WOMBAT, { value: wombat, enumerable: false }),
  ...
  function WombatLocation(orig_loc, wombat) {
    for (var prop in (Object.defineProperties(this, {
      _orig_loc: { configurable: true, enumerable: false, value: orig_loc },
      wombat: { configurable: true, enumerable: false, value: wombat },
      orig_getter: {
        enumerable: false,
        value: function (prop) {
    ...
    return (
      (origListenerFunc =
        typeof origListener === "function"
          ...
          ? origListener.handleEvent.bind(origListener)
          : function () {}),
  ...
  function u(t) {
    ...
    e =
      typeof t == "string"
        ? t
        : t && t.length
        ? t.reduce((r, n) => ((r += String.fromCharCode(n)), r), "")
        : t
        ? t.toString()
        : "";
    try {
  ...
  function w(t) {
    function o(a) {
      return a instanceof Uint8Array && (a = new TextDecoder().decode(a)), a;
    }
  ...
  function p(t, e = !0) {
    ...
    let r = new URLSearchParams(),
      n = {},
      i = (o) =>
        r.has(o) ? (o in n || (n[o] = 1), o + "." + ++n[o] + "_") : o;
    try {
      JSON.stringify(
        t,
        (o, s) => (
          ["object", "function"].includes(typeof s) || r.set(i(o), s), s
        )
      );
    } catch (o) {
      if (!e) throw o;
  ...
  function Wombat($wbwindow, wbinfo) {
    ...
    (this.debug_rw = false),
      ...
      "ignore_prefixes" in wbinfo &&
        (this.IGNORE_PREFIXES = this.IGNORE_PREFIXES.concat(
      ...
      (this.linkTagMods = {
        linkRelToAs: { import: this.linkAsTypes, preload: this.linkAsTypes },
        stylesheet: "cs_",
        null: "mp_",
        undefined: "mp_",
        "": "mp_",
      ...
      !this.wb_info.is_live &&
        this.wb_info.wombat_ts &&
      ...
      (this.rmCheckThisInjectRe =
        /_____WB\$wombat\$check\$this\$function_____\(.*?\)/g),
      ...
      cspViolationListener: function (e) {
        if (
          ...
          e.lineNumber && e.columnNumber
            ...
            : e.lineNumber && (fileInfo += " @ " + e.lineNumber),
  ...
  (FuncMap.prototype.set = function (fnKey, fnValue) {
    ...
    (FuncMap.prototype.get = function (fnKey) {
      for (var i = 0; i < this._map.length; i++)
        if (this._map[i][0] === fnKey) return this._map[i][1];
      return null;
    }),
    (FuncMap.prototype.find = function (fnKey) {
      for (var i = 0; i < this._map.length; i++)
        if (this._map[i][0] === fnKey) return i;
      return -1;
    }),
    (FuncMap.prototype.add_or_get = function (func, initter) {
      var fnValue = this.get(func);
      return (
        fnValue || ((fnValue = initter()), this.set(func, fnValue)), fnValue
      );
    }),
    ...
    (FuncMap.prototype.map = function (param) {
      for (var i = 0; i < this._map.length; i++) this._map[i][1](param);
    });
  ...
  (Storage.prototype.getItem = function getItem(name) {
    ...
    (Storage.prototype.setItem = function setItem(name, value) {
      ...
      return (
        (this[sname] = value), this.fireEvent(sname, old, svalue), undefined
      );
    }),
    ...
    (Storage.prototype.removeItem = function removeItem(name) {
      ...
      return this._deleteItem(name), this.fireEvent(name, old, null), undefined;
    }),
    (Storage.prototype.clear = function clear() {
      for (var member in this) delete this[member];
      return this.fireEvent(null, null, null), undefined;
    }),
    ...
    (AutoFetcher.prototype._initWorker = function (config) {
      ...
      this.worker = {
        postMessage: function (msg) {
          msg.wb_type || (msg = { wb_type: "aaworker", msg: msg }),
    ...
    (AutoFetcher.prototype.preserveSrcset = function (srcset, mod) {
      this.postMessage(
        { type: "values", srcset: { value: srcset, mod: mod, presplit: true } },
        true
      );
    }),
    ...
    (AutoFetcher.prototype.getSrcset = function (elem) {
      return this.wombat.wb_getAttribute
        ? this.wombat.wb_getAttribute.call(elem, "srcset")
        : elem.getAttribute("srcset");
    }),
    (AutoFetcher.prototype.rwMod = function (elem) {
      switch (elem.tagName) {
        case "SOURCE":
          return elem.parentElement && elem.parentElement.tagName === "PICTURE"
            ? "im_"
            : "oe_";
        case "IMG":
          return "im_";
    ...
    (AutoFetcher.prototype.extractFromLocalDoc = function () {
      ...
      Promise.resolve().then(function () {
        ...
        var elem,
          srcv,
          mod,
          elems = document.querySelectorAll(afw.elemSelector),
          srcset = { values: [], presplit: false },
          src = { values: [] };
    ...
    (Wombat.prototype._internalInit = function () {
      ...
      (this.wb_rel_prefix =
        this.wb_replay_prefix && this.wb_replay_prefix.indexOf(wb_origin) === 0
          ? this.wb_replay_prefix.substring(wb_origin.length)
      ...
      (this.wb_unrewrite_rx = new RegExp(rx, "g")),
        this.wb_info.is_framed &&
          this.wb_info.mod !== "bn_" &&
    ...
    (Wombat.prototype._addRemoveCSPViolationListener = function (yesNo) {
      (this.showCSPViolations.yesNo = yesNo),
        this.showCSPViolations.yesNo && !this.showCSPViolations.added
    ...
    (Wombat.prototype._addEventListener = function (obj, event, fun) {
      return this.utilFns.addEventListener
        ? this.utilFns.addEventListener.call(obj, event, fun)
        : void obj.addEventListener(event, fun);
    }),
    (Wombat.prototype._removeEventListener = function (obj, event, fun) {
      return this.utilFns.removeEventListener
        ? this.utilFns.removeEventListener.call(obj, event, fun)
        : void obj.removeEventListener(event, fun);
    }),
    ...
    (Wombat.prototype.isNativeFunction = function (funToTest) {
      ...
      return (
        ...
        (!(funToTest.__WB_is_native_func__ !== undefined) ||
          !!funToTest.__WB_is_native_func__)
      );
    }),
    ...
    (Wombat.prototype.blobUrlForIframe = function (iframe, string) {
      ...
      var blobIdUrl =
        url.slice(url.lastIndexOf("/") + 1) + "/" + this.wb_info.url;
      iframe.src =
        this.wb_info.prefix + this.wb_info.request_ts + "mp_/blob:" + blobIdUrl;
    }),
    ...
    (Wombat.prototype.isSavedDataSrcSrcset = function (elem) {
      return (
        !!(elem.dataset && elem.dataset.srcset != null) &&
    ...
    (Wombat.prototype.isArgumentsObj = function (maybeArgumentsObj) {
      ...
      try {
        return (
          this.utilFns.objToString.call(maybeArgumentsObj) ===
          "[object Arguments]"
        );
      } catch (e) {
        return false;
    ...
    (Wombat.prototype.startsWithOneOf = function (string, prefixes) {
      ...
      for (var i = 0; i < prefixes.length; i++)
        if (string.indexOf(prefixes[i]) === 0) return prefixes[i];
      return undefined;
    }),
    ...
    (Wombat.prototype.skipWrapScriptBasedOnType = function (scriptType) {
      return (
        ...
        (!!(scriptType.indexOf("json") >= 0) ||
          !!(scriptType.indexOf("text/") >= 0))
      );
    }),
    (Wombat.prototype.skipWrapScriptTextBasedOnText = function (text) {
      ...
      for (
        var override_props = [
          ...
          i = 0;
        i < override_props.length;
        i++
      )
        if (text.indexOf(override_props[i]) >= 0) return false;
      return true;
    }),
    ...
    (Wombat.prototype.rwModForElement = function (elem, attrName) {
      ...
      if (!(elem.tagName === "LINK" && attrName === "href")) {
        ...
        } else this.linkTagMods[relV] != null && (mod = this.linkTagMods[relV]);
      }
      return mod;
    }),
    (Wombat.prototype.removeWBOSRC = function (elem) {
      elem.tagName !== "SCRIPT" ||
        elem.__$removedWBOSRC$__ ||
        (elem.hasAttribute("__wb_orig_src") &&
    ...
    (Wombat.prototype.retrieveWBOSRC = function (elem) {
      if (elem.tagName === "SCRIPT" && !elem.__$removedWBOSRC$__) {
        var maybeWBOSRC;
        return (
          (maybeWBOSRC = this.wb_getAttribute
            ? this.wb_getAttribute.call(elem, "__wb_orig_src")
            : elem.getAttribute("__wb_orig_src")),
    ...
    // * jingyz
    (Wombat.prototype.unwrapScriptTextJsProxy = function (scriptText) {
      if (!scriptText || !scriptText.includes('var _____WB$wombat$assign$function_____ ='))
        return scriptText;
      let lines = scriptText.split("\n");
      lines = lines.slice(14, lines.length - 1);
      lines[0] = lines[0].slice(1);
      return lines.join("\n");
    }),
    // * End of jingyz
    (Wombat.prototype.watchElem = function (elem, func) {
      if (!this.$wbwindow.MutationObserver) return false;
      var m = new this.$wbwindow.MutationObserver(function (records, observer) {
        for (var r, i = 0; i < records.length; i++)
          if (((r = records[i]), r.type === "childList"))
            for (var j = 0; j < r.addedNodes.length; j++) func(r.addedNodes[j]);
      });
      m.observe(elem, { childList: true, subtree: true });
    }),
    ...
    (Wombat.prototype.resolveRelUrl = function (url, doc) {
      function isValidBaseURI(doc) {
        return (
          !!(doc && doc.baseURI) &&
          (doc.baseURI.startsWith(wombat.HTTPS_PREFIX) ||
            doc.baseURI.startsWith(wombat.HTTP_PREFIX))
        );
      }
      var wombat = this,
        baseURI = null;
      return (
        (baseURI = isValidBaseURI(doc)
          ? doc.baseURI
          : isValidBaseURI(this.$wbwindow.document)
          ? this.$wbwindow.document.baseURI
          : this.$wbwindow.__WB_replay_top.document.baseURI),
        new this.URL(url, baseURI).href
      );
    }),
    (Wombat.prototype.extractOriginalURL = function (rewrittenUrl) {
      ...
      var start;
      start = this.startsWith(url, this.wb_abs_prefix)
        ? this.wb_abs_prefix.length
        : this.wb_rel_prefix && this.startsWith(url, this.wb_rel_prefix)
        ? this.wb_rel_prefix.length
        : this.wb_rel_prefix
        ? 1
        : 0;
      var index = url.indexOf("/http", start);
      return (
        index < 0 && (index = url.indexOf("///", start)),
        ...
        this.startsWith(url, this.REL_PREFIX)
          ? this.wb_info.wombat_scheme + ":" + url
          : url
      );
    }),
    ...
    (Wombat.prototype._makeURLParser = function (url, docElem) {
      ...
      return (p._no_rewrite = true), (p.href = url), p;
    }),
    (Wombat.prototype.defProp = function (
      obj,
      prop,
      setFunc,
      getFunc,
      ...
      try {
        return Object.defineProperty(obj, prop, descriptor), true;
      } catch (e) {
        return (
          console.warn("Failed to redefine property %s", prop, e.message), false
        );
      }
    }),
    (Wombat.prototype.defGetterProp = function (
      obj,
      prop,
      getFunc,
      enumerable
    ...
    (Wombat.prototype.getOrigGetter = function (obj, prop) {
      var orig_getter;
      if (
        (obj.__lookupGetter__ && (orig_getter = obj.__lookupGetter__(prop)),
    ...
    (Wombat.prototype.getOrigSetter = function (obj, prop) {
      var orig_setter;
      if (
        (obj.__lookupSetter__ && (orig_setter = obj.__lookupSetter__(prop)),
    ...
    (Wombat.prototype.getAllOwnProps = function (obj) {
      for (
        var ownProps = [], props = Object.getOwnPropertyNames(obj), i = 0;
        i < props.length;
        i++
      ) {
        var prop = props[i];
      ...
      for (var traverseObj = Object.getPrototypeOf(obj); traverseObj; ) {
        for (
          props = Object.getOwnPropertyNames(traverseObj), i = 0;
          i < props.length;
          i++
        )
    ...
    (Wombat.prototype.sendTopMessage = function (message, skipTopCheck, win) {
      ...
      win.__WB_top_frame &&
        (skipTopCheck || win == win.__WB_replay_top) &&
    ...
    (Wombat.prototype.updateLocation = function (
      reqHref,
      origHref,
      actualLocation
    ) {
    ...
    (Wombat.prototype.checkLocationChange = function (wombatLoc, isTop) {
      ...
      locType === "string"
        ...
        : locType === "object" &&
          this.updateLocation(
            wombatLoc.href,
            wombatLoc._orig_href,
            actual_location
          );
    }),
    (Wombat.prototype.checkAllLocations = function () {
      return (
        !this.wb_wombat_updating &&
        void ((this.wb_wombat_updating = true),
    ...
    // *jingyz
    (Wombat.prototype.invarCheckProp = function (prop) {
      return ["top", "parent"].indexOf(prop) !== -1;
    }), // *End of jingyz
    ...
    (Wombat.prototype.defaultProxyGet = function (
      obj,
      prop,
      ownProps,
      fnCache
      ...
      if (type === "function" && ownProps.indexOf(prop) !== -1) {
        switch (prop) {
          ...
          case "cancelAnimationFrame": {
            if (!this.isNativeFunction(retVal)) return retVal;
            break;
          }
          case "eval":
            if (this.isNativeFunction(retVal)) return this.wrappedEval(retVal);
        }
        var cachedFN = fnCache[prop];
        return (
          (cachedFN && cachedFN.original === retVal) ||
            ((cachedFN = { original: retVal, boundFn: retVal.bind(obj) }),
            (fnCache[prop] = cachedFN)),
          cachedFN.boundFn
        );
      }
      return type === "object" && retVal && retVal._WB_wombat_obj_proxy
        ? (retVal instanceof this.WBWindow && this.initNewWindowWombat(retVal),
          retVal._WB_wombat_obj_proxy)
        : retVal;
    }),
    (Wombat.prototype.setLoc = function (loc, originalURL) {
      var parser = this.makeParser(originalURL, loc.ownerDocument);
      (loc._orig_href = originalURL), (loc._parser = parser);
    ...
    (Wombat.prototype.makeGetLocProp = function (prop, origGetter) {
      ...
      return function newGetLocProp() {
        ...
        return prop === "href"
          ? wombat.extractOriginalURL(curr_orig_href)
          : prop === "ancestorOrigins"
          ? []
          : (this._orig_href !== curr_orig_href &&
    ...
    (Wombat.prototype.makeSetLocProp = function (prop, origSetter, origGetter) {
      ...
      return function newSetLocProp(value) {
        ...
        if (this["_" + prop] !== value) {
          ...
          prop === "hash"
            ? ((value = parser[prop]), origSetter.call(this, "hash", value))
    ...
    (Wombat.prototype.styleReplacer = function (
      match,
      n1,
      n2,
      n3,
    ...
    (Wombat.prototype.domConstructorErrorChecker = function (
      ...
      var errorMsg,
        needArgs = typeof numRequiredArgs === "number" ? numRequiredArgs : 1;
      if (
        (thisObj instanceof this.WBWindow
          ? (errorMsg =
              "Failed to construct '" +
              what +
              "': Please use the 'new' operator, this DOM object constructor cannot be called as a function.")
          : args &&
            args.length < needArgs &&
            (errorMsg =
              "Failed to construct '" +
              what +
              "': " +
    ...
    (Wombat.prototype.rewriteWSURL = function (originalURL) {
      ...
      var wsScheme = "ws://",
        wssScheme = "wss://";
      if (this.wb_is_proxy)
        return this.wb_orig_scheme === this.HTTP_PREFIX &&
          this.startsWith(url, wssScheme)
          ? "ws://" + url.substr(wssScheme.length)
          : this.wb_orig_scheme === this.HTTPS_PREFIX &&
            this.startsWith(url, "ws://")
          ? wssScheme + url.substr(5)
          : url;
      var wbSecure = this.wb_abs_prefix.indexOf(this.HTTPS_PREFIX) === 0,
        wbPrefix = this.wb_abs_prefix.replace(
    ...
    (Wombat.prototype.rewriteUrl_ = function (originalURL, useRel, mod, doc) {
      if (!originalURL) return originalURL;
      var url,
        urltype_ = typeof originalURL;
      if (urltype_ === "object") url = originalURL.toString();
      else {
        if (urltype_ !== "string") return originalURL;
        url = originalURL;
      }
      if (!url) return url;
      if (this.wb_is_proxy)
        return this.wb_orig_scheme === this.HTTP_PREFIX &&
          ...
          ? this.HTTP_PREFIX + url.substr(this.HTTPS_PREFIX.length)
          : this.wb_orig_scheme === this.HTTPS_PREFIX &&
            this.startsWith(url, this.HTTP_PREFIX)
          ? this.HTTPS_PREFIX + url.substr(this.HTTP_PREFIX.length)
          : url;
      if (
      ...
      var check_url;
      if (
        ((check_url = url.indexOf("//") === 0 ? this.origProtocol + url : url),
      ...
      if (
        ...
        this.startsWith(url, this.origProtocol + "//" + this.origHostname + "/")
      )
        return url.replace(
          "/" + this.origHostname + "/",
          "/" + this.origHost + "/"
      ...
      if (url.charAt(0) === "/" && !this.startsWith(url, this.REL_PREFIX)) {
        ...
        if (url.indexOf(this.wb_rel_prefix) === 0 && url.indexOf("http") > 1) {
          ...
          return scheme_sep > 0 && url[scheme_sep + 2] !== "/"
            ? url.substring(0, scheme_sep + 2) +
                "/" +
      ...
      if (prefix) {
        ...
        if (this.startsWith(url, prefix_host)) {
          if (this.startsWith(url, this.wb_replay_prefix)) return url;
          var curr_scheme = orig_protocol + "//",
            path = url.substring(prefix_host.length),
            rebuild = false;
          return (
            path.indexOf(this.wb_rel_prefix) < 0 &&
              ...
              (rebuild = true)),
            prefix !== curr_scheme &&
              prefix !== this.REL_PREFIX &&
              (rebuild = true),
            rebuild &&
              ((url = useRel ? "" : curr_scheme + orig_host),
              path && path[0] !== "/" && (url += "/"),
              (url += path)),
            url
          );
      ...
      return (
        ...
        prefix
          ? this.getFinalUrl(useRel, mod, this.extractOriginalURL(url))
          : url
      );
    }),
    (Wombat.prototype.rewriteUrl = function (url, useRel, mod, doc) {
      var rewritten;
      return (
        (rewritten = this.wb_info.rewrite_function
          ? this.wb_info.rewrite_function(url, useRel, mod, doc)
          : this.rewriteUrl_(url, useRel, mod, doc)),
        this.debug_rw &&
          (url === rewritten
    ...
    (Wombat.prototype.rewriteAttr = function (elem, name, absUrlOnly) {
      ...
      var new_value = this.performAttributeRewrite(
        elem,
        name,
        value,
        absUrlOnly
    ...
    (Wombat.prototype.rewriteStyle = function (style) {
      ...
      var value = style;
      return (
        typeof style === "object" && (value = style.toString()),
        typeof value === "string"
          ? value
    ...
    (Wombat.prototype.rewriteSrcset = function (value, elem) {
      ...
      for (
        var v,
          split = value.split(this.srcsetRe),
          values = [],
          mod = this.rwModForElement(elem, "srcset"),
          i = 0;
        i < split.length;
        i++
      )
    ...
    (Wombat.prototype.rewriteFrameSrc = function (elem, attrName) {
      var new_value,
        value = this.wb_getAttribute.call(elem, attrName);
      if (
        this.startsWith(value, "javascript:") &&
        value.indexOf("WB_wombat_") >= 0
      ) {
        var JS = "javascript:";
        new_value =
          "javascript:window.parent._wb_wombat.initNewWindowWombat(window);" +
          value.substr(11);
      }
      return (
        new_value ||
        ...
        new_value !== value &&
          (this.wb_setAttribute.call(elem, attrName, new_value), true)
      );
    }),
    (Wombat.prototype.rewriteScript = function (elem) {
      ...
      return (
        !this.skipWrapScriptTextBasedOnText(text) &&
        ((elem.textContent = this.wrapScriptTextJsProxy(text)),
        this.wb_info.injectDocClose &&
          elem.textContent.trim().length &&
    ...
    (Wombat.prototype.rewriteElem = function (elem) {
      ...
      if (elem instanceof SVGElement) changed = this.rewriteSVGElem(elem);
        ...
        switch (elem.tagName) {
          case "META":
            ...
            maybeCSP &&
              maybeCSP.toLowerCase() === "content-security-policy" &&
          ...
          case "OBJECT":
            if (
              this.wb_info.isSW &&
              elem.parentElement &&
              elem.getAttribute("type") === "application/pdf"
            ) {
              for (
              ...
              elem.parentElement.replaceChild(iframe, elem), (changed = true);
              break;
            }
          ...
          case "IFRAME":
            if (
              ...
              if (
                (elem.hasAttribute("srcdoc") && elem.removeAttribute("srcdoc"),
                srcdoc)
              )
                ...
                (src && src !== "about:blank") ||
                  (!src && (elem.__WB_blank = true),
                  (elem.src =
                    this.wb_info.prefix +
                    this.wb_info.request_ts +
                    "mp_/about:blank"));
              }
            }
            changed = this.rewriteAttr(elem, "style") || changed;
          ...
          case "A":
            if (
              ...
              newTarget !== elem.target &&
                ((elem.target = newTarget), (changed = true));
            }
            break;
          default: {
            (changed = this.rewriteAttr(elem, "src")),
      ...
      return (
        elem.hasAttribute &&
          ...
          (elem.hasAttribute("crossorigin") &&
            (elem.removeAttribute("crossorigin"), (changed = true)),
          elem.hasAttribute("integrity") &&
            (elem.removeAttribute("integrity"), (changed = true))),
        changed
      );
    }),
    (Wombat.prototype.recurseRewriteElem = function (curr) {
      ...
      for (
        var changed = false, rewriteQ = [curr.children || curr.childNodes];
        rewriteQ.length > 0;

      )
        for (
          var child, children = rewriteQ.shift(), i = 0;
          i < children.length;
          i++
        )
          (child = children[i]),
    ...
    (Wombat.prototype.rewriteElementsInArguments = function (
      originalArguments
    ) {
      for (
        var argElem, argArr = new Array(originalArguments.length), i = 0;
        i < originalArguments.length;
        i++
      )
        (argElem = originalArguments[i]),
          argElem instanceof Node
            ? (this.rewriteElemComplete(argElem), (argArr[i] = argElem))
            : typeof argElem === "string"
    ...
    (Wombat.prototype.rewriteHtml = function (string, checkEndTag) {
      ...
      var rwString = string;
      if (
        (typeof string !== "string" && (rwString = string.toString()),
        this.write_buff &&
          ((rwString = this.write_buff + rwString), (this.write_buff = "")),
        rwString.indexOf("<script") <= 0 &&
          (rwString = rwString.replace(
            /((id|class)=".*)WB_wombat_([^"]+)/,
            "$1$3"
          )),
        ...
        if (checkEndTag) {
          ...
          if (first_elem) {
            ...
            if (
              ...
              new_html.trimEnd().endsWith(end_tag) &&
              !rwString.trimEnd().endsWith(end_tag)
            ) {
            ...
            rwString[0] !== "<" ||
            rwString[rwString.length - 1] !== ">"
          )
            return (this.write_buff += rwString), undefined;
        }
        return new_html;
      }
      return rwString;
      ...
      return (
        (rwCookie = rwCookie
          .replace(this.cookie_domain_regex, function (m, m1) {
            var message = { domain: m1, cookie: rwCookie, wb_type: "cookie" };
            return (
              ...
              !wombat.IP_RX.test(wombat.$wbwindow.location.hostname)
                ? "Domain=." + wombat.$wbwindow.location.hostname
                : ""
            );
          })
          .replace(this.cookie_path_regex, function (m, m1) {
            ...
            return (
              rewritten.indexOf(wombat.wb_curr_host) === 0 &&
                (rewritten = rewritten.substring(wombat.wb_curr_host.length)),
              "Path=" + rewritten
            );
          })),
        wombat.$wbwindow.location.protocol !== "https:" &&
    ...
    (Wombat.prototype.rewriteTextNodeFn = function (
      fnThis,
      originalFn,
      argsObj
    ) {
      var args,
        deproxiedThis = this.proxyToObj(fnThis);
      if (
        argsObj.length > 0 &&
        ...
        dataIndex === 2
          ? ((args[0] = argsObj[0]), (args[1] = argsObj[1]))
          : dataIndex === 1 && (args[0] = argsObj[0]),
          (args[dataIndex] = this.rewriteStyle(argsObj[dataIndex]));
      } else args = argsObj;
      return originalFn.__WB_orig_apply
        ? originalFn.__WB_orig_apply(deproxiedThis, args)
        : originalFn.apply(deproxiedThis, args);
    }),
    (Wombat.prototype.rewriteChildNodeFn = function (
      fnThis,
      originalFn,
      argsObj
    ) {
      ...
      return originalFn.__WB_orig_apply
        ? originalFn.__WB_orig_apply(thisObj, newArgs)
        : originalFn.apply(thisObj, newArgs);
    }),
    (Wombat.prototype.rewriteInsertAdjHTMLOrElemArgs = function (
      ...
      return fnThisObj._no_rewrite
        ? originalFn.call(fnThisObj, position, textOrElem)
        : rwHTML
        ? originalFn.call(fnThisObj, position, this.rewriteHtml(textOrElem))
    ...
    (Wombat.prototype.rewriteSetTimeoutInterval = function (
      ...
      if (rw) {
        args[0] = this.$wbwindow.Proxy
          ? this.wrapScriptTextJsProxy(argsObj[0])
          : argsObj[0].replace(/\blocation\b/g, "WB_wombat_$&");
        for (var i = 1; i < argsObj.length; ++i)
          args[i] = this.proxyToObj(argsObj[i]);
      }
      var thisObj = this.proxyToObj(fnThis);
      return originalFn.__WB_orig_apply
        ? originalFn.__WB_orig_apply(thisObj, args)
        : originalFn.apply(thisObj, args);
    }),
    (Wombat.prototype.rewriteHTMLAssign = function (
      thisObj,
      oSetter,
      newValue
    ) {
      ...
      thisObj._no_rewrite ||
        thisObj instanceof this.$wbwindow.HTMLTemplateElement ||
        (tagName === "STYLE"
          ? (res = this.rewriteStyle(newValue))
          : tagName === "SCRIPT"
          ? (newValue &&
              this.IsTagRegex.test(newValue) &&
    ...
    (Wombat.prototype.rewriteEvalArg = function (
      rawEvalOrWrapper,
      evalArg,
      extraArg
    ) {
    ...
    (Wombat.prototype.otherEvalRewrite = function (value) {
      return typeof value === "string"
        ? value.replace(this.IMPORT_JS_REGEX, this.styleReplacer)
        : value;
    }),
    ...
    (Wombat.prototype.newAttrObjGetSet = function (attrProto, prop) {
      ...
      this.defProp(
        ...
        function newAttrObjGetter() {
          ...
          return wombat.isAttrObjRewrite(obj)
    ...
    (Wombat.prototype.overrideAttr = function (obj, attr, mod) {
      var orig_getter = this.getOrigGetter(obj, attr),
        ...
        setter = function newAttrPropSetter(orig) {
          mod !== "js_" ||
            this.__$removedWBOSRC$__ ||
            wombat.removeWBOSRC(this);
          var val = wombat.rewriteUrl(orig, false, mod);
          if (orig_setter) return orig_setter.call(this, val);
          return wombat.wb_setAttribute
            ? wombat.wb_setAttribute.call(this, attr, val)
            : void 0;
        },
    ...
    (Wombat.prototype.overrideHistoryFunc = function (funcName) {
        ...
        rewrittenFunc = function histNewFunc(stateObj, title, url) {
          ...
          wombat.WBAutoFetchWorker &&
            historyWin.setTimeout(function () {
              title ||
                historyWin.document.title === origTitle ||
      ...
      return (
        ...
        this.$wbwindow.History &&
          this.$wbwindow.History.prototype &&
    ...
    (Wombat.prototype.overrideStyleAttr = function (obj, attr, propName) {
      ...
      orig_getter ||
        ...
        ((orig_setter && orig_getter) || propName) &&
          this.defProp(obj, attr, setter, getter);
    }),
    ...
    (Wombat.prototype.overrideAnchorAreaElem = function (whichObj) {
      if (whichObj && whichObj.prototype) {
        for (
          var prop,
            originalGetSets = {},
            originalProto = whichObj.prototype,
            anchorAreaSetter = function anchorAreaSetter(prop, value) {
            ...
            i = 0;
          i < this.URL_PROPS.length;
          i++
        )
          (prop = this.URL_PROPS[i]),
            (originalGetSets["get_" + prop] = this.getOrigGetter(
              originalProto,
              prop
            )),
            (originalGetSets["set_" + prop] = this.getOrigSetter(
              originalProto,
              prop
            )),
            Object.defineProperty &&
    ...
    (Wombat.prototype.overrideHtmlAssign = function (
      elem,
      prop,
      rewriteGetter
    ) {
            ...
            proxy = new Proxy(dataset, {
              get(target, prop, receiver) {
                ...
                return typeof result === "string" &&
                  ...
                  ? wombat.extractOriginalURL(result)
                  : result;
              },
            });
          return proxy;
            ...
            proxy = new Proxy(style, {
              ...
              get(target, prop, receiver) {
                ...
                return typeof value === "function" &&
                  (prop === "setProperty" || wombat.isNativeFunction(value))
                  ? (fnCache[prop] || (fnCache[prop] = value.bind(style)),
                    fnCache[prop])
                  : value;
              },
            });
    ...
    (Wombat.prototype.overrideSWAccess = function ($wbwindow) {
      if (
        $wbwindow.navigator.serviceWorker &&
        $wbwindow.navigator.serviceWorker.controller
      ) {
    ...
    (Wombat.prototype.overrideFuncThisProxyToObj = function (cls, method, obj) {
      if (cls) {
        var ovrObj = obj;
        if (
          (!obj && cls.prototype && cls.prototype[method]
            ? (ovrObj = cls.prototype)
            : !obj && cls[method] && (ovrObj = cls),
          !!ovrObj)
        ) {
          var wombat = this,
            orig = ovrObj[method];
        ...
        if (orig) {
          ...
          cls.prototype[method] = function deproxyFnArg() {
            for (
              ...
              args[i] =
                i === argIndex ? wombat.proxyToObj(arguments[i]) : arguments[i];
            var thisObj = wombat.proxyToObj(this);
            return orig.__WB_orig_apply
              ? orig.__WB_orig_apply(thisObj, args)
              : orig.apply(thisObj, args);
          };
        }
      }
    }),
    ...
    (Wombat.prototype.overrideFunctionBind = function ($wbwindow) {
      if (!$wbwindow.Function.prototype.__WB_orig_bind) {
        ...
        $wbwindow.Function.prototype.bind = function bind(obj) {
          ...
          return (result.__WB_is_native_func__ = isNative), result;
        };
      }
    }),
    (Wombat.prototype.overrideSrcsetAttr = function (obj, mod) {
      var prop = "srcset",
        ...
        setter = function srcset(orig) {
          ...
          if (orig_setter) return orig_setter.call(this, val);
          return wombat.wb_setAttribute
            ? wombat.wb_setAttribute.call(this, "srcset", val)
            : void 0;
        },
    ...
    (Wombat.prototype.overrideHrefAttr = function (obj, mod) {
      var orig_getter = this.getOrigGetter(obj, "href"),
        ...
        setter = function href(orig) {
          var val;
          return ((val =
            mod === "cs_" && orig.indexOf("data:text/css") === 0
              ? wombat.rewriteInlineStyle(orig)
              : this.tagName === "LINK"
              ? wombat.rewriteUrl(
                  orig,
                  false,
              ...
              : wombat.rewriteUrl(orig, false, mod, this.ownerDocument)),
          orig_setter)
            ? orig_setter.call(this, val)
            : wombat.wb_setAttribute
            ? wombat.wb_setAttribute.call(this, "href", val)
            : void 0;
        },
    ...
    (Wombat.prototype.overrideTextProtoGetSet = function (
      textProto,
      whichProp
    ) {
      var setter,
        orig_getter = this.getOrigGetter(textProto, whichProp),
        wombat = this;
      if (whichProp === "data") {
      ...
      var getter = function rwTextProtoGetter() {
        var res = orig_getter.call(this);
        return !this._no_rewrite &&
          this.parentElement &&
          this.parentElement.tagName === "STYLE"
          ? res.replace(wombat.wb_unrewrite_rx, "")
          : res;
      };
        ...
        if (ConstructorFN.prototype[initFNKey]) {
          ...
          ConstructorFN.prototype[initFNKey] = function () {
            ...
            if (arguments.length === 0 || arguments.length < 3)
              return originalInitFn.__WB_orig_apply
                ? originalInitFn.__WB_orig_apply(thisObj, arguments)
                : originalInitFn.apply(thisObj, arguments);
            for (
              var newArgs = new Array(arguments.length), i = 0;
              i < arguments.length;
              i++
            )
              newArgs[i] =
                i === 3 ? wombat.proxyToObj(arguments[i]) : arguments[i];
            return originalInitFn.__WB_orig_apply
              ? originalInitFn.__WB_orig_apply(thisObj, newArgs)
              : originalInitFn.apply(thisObj, newArgs);
          };
        }
    ...
    (Wombat.prototype.rewriteParentNodeFn = function (
      fnThis,
      originalFn,
      argsObj
    ) {
      ...
      return originalFn.__WB_orig_apply
        ? originalFn.__WB_orig_apply(thisObj, argArr)
        : originalFn.apply(thisObj, argArr);
    }),
    ...
    (Wombat.prototype.overrideShadowDom = function () {
      this.$wbwindow.ShadowRoot &&
        this.$wbwindow.ShadowRoot.prototype &&
    ...
    (Wombat.prototype.overrideChildNodeInterface = function (
      ...
      if (ifaceWithChildNode && ifaceWithChildNode.prototype) {
        var rewriteFn = textIface
          ? this.rewriteTextNodeFn
          : this.rewriteChildNodeFn;
      ...
      if (Text && Text.prototype) {
        ...
        if (textProto.appendData) {
          ...
          textProto.appendData = function appendData() {
            return rewriteTextProtoFunction(
              this,
              originalAppendData,
              arguments
            );
    ...
    (Wombat.prototype.initAttrOverrides = function () {
      this.overrideHrefAttr(this.$wbwindow.HTMLLinkElement.prototype, "cs_"),
        ...
        this.overrideSrcsetAttr(
          this.$wbwindow.HTMLImageElement.prototype,
          "im_"
        ),
        this.overrideSrcsetAttr(
          this.$wbwindow.HTMLSourceElement.prototype,
          "oe_"
        ),
        this.overrideAttr(
          this.$wbwindow.HTMLVideoElement.prototype,
          "poster",
          "im_"
        ),
        this.overrideAttr(
          this.$wbwindow.HTMLAudioElement.prototype,
          "poster",
          "im_"
        ),
        this.overrideAttr(
        ...
        this.overrideAttr(
          this.$wbwindow.HTMLInputElement.prototype,
          "src",
          "oe_"
        ),
        this.overrideAttr(
          this.$wbwindow.HTMLEmbedElement.prototype,
          "src",
          "oe_"
        ),
        this.overrideAttr(
          this.$wbwindow.HTMLMediaElement.prototype,
          "src",
          "oe_"
        ),
        this.overrideAttr(
        ...
        window.HTMLTrackElement &&
          ...
          this.overrideAttr(
            this.$wbwindow.HTMLTrackElement.prototype,
            "src",
            "oe_"
          ),
        this.overrideAttr(
        ...
        this.overrideAttr(
          this.$wbwindow.HTMLScriptElement.prototype,
          "src",
          "js_"
        ),
        this.overrideAttr(
        ...
        this.overrideAttr(
          this.$wbwindow.HTMLMetaElement.prototype,
          "content",
          "mp_"
        ),
        this.overrideAttr(
          this.$wbwindow.HTMLFormElement.prototype,
          "action",
          "mp_"
        ),
        this.overrideAttr(
          this.$wbwindow.HTMLQuoteElement.prototype,
          "cite",
          "mp_"
        ),
        this.overrideAttr(
          this.$wbwindow.HTMLModElement.prototype,
          "cite",
          "mp_"
        ),
      ...
      this.$wbwindow.CSSRule &&
        this.$wbwindow.CSSRule.prototype &&
      ...
      if (
        ...
        this.$wbwindow.StylePropertyMap.prototype.set = function set() {
          if (arguments.length <= 1)
            return originalSet.__WB_orig_apply
              ? originalSet.__WB_orig_apply(this, arguments)
          ...
          return originalSet.__WB_orig_apply
            ? originalSet.__WB_orig_apply(this, newArgs)
            : originalSet.apply(this, newArgs);
        };
        ...
        this.$wbwindow.StylePropertyMap.prototype.append = function append() {
          if (arguments.length <= 1)
            return originalSet.__WB_orig_apply
              ? originalAppend.__WB_orig_apply(this, arguments)
              : originalAppend.apply(this, arguments);
          var newArgs = new Array(arguments.length);
          newArgs[0] = arguments[0];
          for (var i = 1; i < arguments.length; i++)
            newArgs[i] = wombat.noExceptRewriteStyle(arguments[i]);
          return originalAppend.__WB_orig_apply
            ? originalAppend.__WB_orig_apply(this, newArgs)
            : originalAppend.apply(this, newArgs);
        };
      }
    }),
          ...
          (this.$wbwindow.Date = (function (Date_) {
            return function Date(A, B, C, D, E, F, G) {
              return A === undefined
                ...
                ? new Date_(A, B, C, D, E)
                : G === undefined
                ? new Date_(A, B, C, D, E, F)
                : new Date_(A, B, C, D, E, F, G);
            };
          })(this.$wbwindow.Date)),
          ...
          return function Blob(array, options) {
            return (
              options &&
                ...
                wombat.startsWith(array[0], "<!DOCTYPE html>") &&
    ...
    (Wombat.prototype.initWSOverride = function () {
      this.$wbwindow.WebSocket &&
        this.$wbwindow.WebSocket.prototype &&
        ((this.$wbwindow.WebSocket = (function (WebSocket_) {
          function WebSocket(url, protocols) {
            ...
            (this.openCallbacks = []),
              ...
              (this.protocol =
                protocols && protocols.length ? protocols[0] : ""),
              (this.url = url),
              (this.readyState = 1);
            var ws = this;
      ...
      var orig_get_title = this.getOrigGetter(this.$wbwindow.document, "title"),
        ...
        set_title = function title(value) {
          var res = orig_set_title.call(this, value),
            message = { wb_type: "title", title: value };
          return wombat.sendTopMessage(message), res;
        };
    ...
    (Wombat.prototype.initFontFaceOverride = function () {
      if (this.$wbwindow.FontFace) {
        ...
        (this.$wbwindow.FontFace = (function (FontFace_) {
          ...
          Object.defineProperty(
            this.$wbwindow.FontFace.prototype,
            "constructor",
    ...
    (Wombat.prototype.initPaths = function (wbinfo) {
      (wbinfo.wombat_opts = wbinfo.wombat_opts || {}),
        ...
        (this.wb_abs_prefix = this.wb_replay_prefix),
        (this.wb_capture_date_part =
          !wbinfo.is_live && wbinfo.wombat_ts
            ? "/" + wbinfo.wombat_ts + "/"
            : ""),
    ...
    (Wombat.prototype.initCookiePreset = function () {
      if (this.wb_info.presetCookie)
        for (
          var splitCookies = this.wb_info.presetCookie.split(";"), i = 0;
          i < splitCookies.length;
          i++
        )
          this.$wbwindow.document.cookie =
            splitCookies[i].trim() + "; Path=" + this.rewriteUrl("./", true);
    }),
    (Wombat.prototype.initHTTPOverrides = function () {
      ...
      if (
        ...
        var origOpen = this.$wbwindow.XMLHttpRequest.prototype.open,
          origSetRequestHeader =
            this.$wbwindow.XMLHttpRequest.prototype.setRequestHeader,
        ...
        (this.utilFns.XHRopen = origOpen),
          ...
          (this.$wbwindow.XMLHttpRequest.prototype.setRequestHeader = function (
            name,
            value
          ) {
        ...
        this.$wbwindow.XMLHttpRequest.prototype.send = async function (value) {
          if (
            convertToGet &&
            (this.__WB_xhr_open_arguments[0] === "POST" ||
              this.__WB_xhr_open_arguments[0] === "PUT")
          ) {
            var request = {
      ...
      if (this.$wbwindow.fetch) {
        ...
        this.$wbwindow.fetch = function fetch(input, init_opts) {
          ...
          if (inputType === "string") rwInput = wombat.rewriteUrl(input);
          ...
          if (
            (init_opts || (init_opts = {}), init_opts.credentials === undefined)
          )
            try {
        ...
        (this.$wbwindow.Request = (function (Request_) {
          return function Request(input, init_opts) {
            ...
            return (
              ...
              newInitOpts.referrer &&
                (newInitOpts.referrer = wombat.rewriteUrl(
                  newInitOpts.referrer
                )),
          ...
          Object.defineProperty(
            this.$wbwindow.Request.prototype,
            "constructor",
      ...
      if (this.$wbwindow.EventSource && this.$wbwindow.EventSource.prototype) {
        ...
        (this.$wbwindow.EventSource = (function (EventSource_) {
          ...
          Object.defineProperty(
            this.$wbwindow.EventSource.prototype,
            "constructor",
            ...
            (ElementProto.setAttribute = function setAttribute(name, value) {
              ...
              if (name && typeof rwValue === "string") {
                ...
                if (
                  ...
                  var shouldRW = wombat.shouldRewriteAttr(
                    this.tagName,
                    lowername
                  );
                  shouldRW &&
        ...
        if (ElementProto.getAttribute) {
          ...
          (this.wb_getAttribute = orig_getAttribute),
            (ElementProto.getAttribute = function getAttribute(name) {
              ...
              return wombat.startsWith(lowerName, "data-") &&
                wombat.startsWithOneOf(result, wombat.wb_prefixes)
                ? wombat.extractOriginalURL(result)
                : result;
            });
    ...
    (Wombat.prototype.initSvgImageOverrides = function () {
      if (this.$wbwindow.SVGImageElement) {
        ...
        (svgImgProto.getAttribute = function getAttribute(name) {
          ...
          return name.indexOf("xlink:href") >= 0 || name === "href"
            ? wombat.extractOriginalURL(value)
            : value;
        }),
          ...
          (svgImgProto.setAttribute = function setAttribute(name, value) {
            var rwValue = value;
            return (
              (name.indexOf("xlink:href") >= 0 || name === "href") &&
                (rwValue = wombat.rewriteUrl(value)),
              orig_setAttr.call(this, name, rwValue)
            );
          }),
          (svgImgProto.setAttributeNS = function setAttributeNS(
            ns,
            name,
            value
          ) {
      ...
      if (Object.defineProperty) {
        ...
        var wombat = this,
          domain_setter = function domain(val) {
            ...
            loc &&
              wombat.endsWith(loc.hostname, val) &&
      ...
      if (this.$wbwindow.DOMParser) {
        ...
        var originalClose = $wbDocument.close,
          newClose = function close() {
            ...
            return (
              wombat.initNewWindowWombat(thisObj.defaultView),
              originalClose.__WB_orig_apply
                ? originalClose.__WB_orig_apply(thisObj, arguments)
                : originalClose.apply(thisObj, arguments)
            );
          };
    ...
    (Wombat.prototype.initIframeWombat = function (iframe) {
      var win;
      win = iframe._get_contentWindow
        ? iframe._get_contentWindow.call(iframe)
    ...
    (Wombat.prototype.initNewWindowWombat = function (win, src) {
      ...
      if (win && !win._wb_wombat) {
        if (
          ...
          (origURL === "about:blank" ||
            origURL.startsWith("srcdoc:") ||
            origURL.startsWith("blob:")) &&
            (fullWombat = true);
        }
        if (fullWombat) {
          var newInfo = {};
    ...
    (Wombat.prototype.initTimeoutIntervalOverrides = function () {
      ...
      if (
        this.$wbwindow.setTimeout &&
        !this.$wbwindow.setTimeout.__$wbpatched$__
      ) {
    ...
    (Wombat.prototype.initWorkerOverrides = function () {
      ...
      if (
        ...
        !this.$wbwindow.Worker._wb_worker_overridden
      ) {
        ...
        (this.$wbwindow.Worker = (function (Worker_) {
          ...
          Object.defineProperty(
            this.$wbwindow.Worker.prototype,
            "constructor",
      ...
      if (
        ...
        this.$wbwindow.ServiceWorkerContainer.prototype.register =
          function register(scriptURL, options) {
            var newScriptURL = new wombat.URL(
                scriptURL,
                wombat.$wbwindow.document.baseURI
              ).href,
    ...
    (Wombat.prototype.initWombatLoc = function (win) {
      if (
        !(!win || (win.WB_wombat_location && win.document.WB_wombat_location))
      ) {
    ...
    (Wombat.prototype.initProtoPmOrigin = function (win) {
      if (!win.Object.prototype.__WB_pmw) {
        var pm_origin = function pm_origin(origin_window) {
          return (this.__WB_source = origin_window), this;
        };
        try {
    ...
    (Wombat.prototype.initCheckThisFunc = function (win) {
      try {
        win.Object.prototype[this.WB_CHECK_THIS_FUNC] ||
    ...
    (Wombat.prototype.initImportWrapperFunc = function (win) {
      ...
      win.____wb_rewrite_import__ = function (base, url) {
        return (
          base && (url = new wombat.URL(url, base).href),
      ...
      try {
        win.Object.defineProperty(win.Object, "getOwnPropertyNames", {
          value: function (object) {
            for (
              var foundInx, props = orig_getOwnPropertyNames(object), i = 0;
              i < removeProps.length;
              i++
            )
        ...
        var wombat = this,
          receive_hash_change = function receive_hash_change(event) {
            if (event.data && event.data.from_top) {
              ...
              message.wb_type &&
                (message.wb_type !== "outer_hashchange" ||
    ...
    (Wombat.prototype.initPostMessageOverride = function ($wbwindow) {
      if ($wbwindow.postMessage && !$wbwindow.__orig_postMessage) {
        ...
        var postmessage_rewritten = function postMessage(
          ...
          var from,
            src_id,
            this_obj = wombat.proxyToObj(this);
          if (
            (this_obj ||
              ((this_obj = $wbwindow), (this_obj.__WB_source = $wbwindow)),
            ...
            if (
              ...
              this_obj.__WB_win_id ||
                ((this_obj.__WB_win_id = {}), (this_obj.__WB_counter = 0)),
              !source.__WB_id)
            ) {
          ...
          } else from = window.WB_wombat_location.origin;
        ...
        eventTarget =
          $wbwindow.EventTarget && $wbwindow.EventTarget.prototype
            ? $wbwindow.EventTarget.prototype
            : $wbwindow;
        ...
        eventTarget.addEventListener = function addEventListener(
          ...
          var rwListener,
            obj = wombat.proxyToObj(this);
          if (
            (type === "message"
              ? (rwListener = wombat.message_listeners.add_or_get(
                  listener,
                  function () {
        ...
        eventTarget.removeEventListener = function removeEventListener(
          ...
          if (
            ...
            return _oRemoveEventListener.call(
              obj,
              type,
              rwListener,
              useCapture
    ...
    (Wombat.prototype.initMessageEventOverride = function ($wbwindow) {
      !$wbwindow.MessageEvent ||
        $wbwindow.MessageEvent.prototype.__extended ||
    ...
    (Wombat.prototype.initOpenOverride = function () {
      ...
      this.$wbwindow.Window.prototype.open &&
        (orig = this.$wbwindow.Window.prototype.open);
      var wombat = this,
        open_rewritten = function open(
          strUrl,
          strWindowName,
          strWindowFeatures
        ) {
          ...
          return wombat.initNewWindowWombat(res, strUrl), res;
        };
    ...
    (Wombat.prototype.rewriteAttrTarget = function (target) {
      return this.wb_info.target_frame
        ? target === "_blank" || target === "_parent" || target === "_top"
          ? this.wb_info.target_frame
          : target && this.$wbwindow === this.$wbwindow.__WB_replay_top
          ? this.wb_info.target_frame
          : target
        : target;
    }),
    (Wombat.prototype.initCookiesOverride = function () {
      var orig_get_cookie = this.getOrigGetter(
          this.$wbwindow.document,
          "cookie"
        ),
          ...
          if (value) {
            for (
              var newValue = value.replace(
                  wombat.cookie_expires_regex,
                  rwCookieReplacer
                ),
                cookies = newValue.split(wombat.SetCookieRe),
                i = 0;
              i < cookies.length;
              i++
            )
              cookies[i] = wombat.rewriteCookie(cookies[i]);
            return orig_set_cookie.call(
              wombat.proxyToObj(this),
              cookies.join(",")
            );
          }
    ...
    (Wombat.prototype.initRegisterUnRegPHOverride = function () {
      ...
      if (winNavigator.unregisterProtocolHandler) {
        ...
        winNavigator.unregisterProtocolHandler =
          function unregisterProtocolHandler(scheme, url) {
    ...
    (Wombat.prototype.initMiscNavigatorOverrides = function () {
      this.$wbwindow.navigator.mediaDevices &&
        (this.$wbwindow.navigator.mediaDevices.setCaptureHandleConfig =
          function () {});
    }),
        ...
        (this.$wbwindow.PresentationRequest = (function (PresentationRequest_) {
          return function PresentationRequest(url) {
            ...
            if (url != null)
              ...
              else rwURL = wombat.rewriteUrl(url, true, "mp_");
    ...
    (Wombat.prototype.initDisableNotificationsGeoLocation = function () {
      window.Notification &&
        (window.Notification.requestPermission = function requestPermission(
          ...
          return callback && callback("denied"), Promise.resolve("denied");
        });
        ...
        on &&
          (on.getCurrentPosition &&
            (on.getCurrentPosition = function getCurrentPosition(
              ...
              error && error({ code: 2, message: "not available" });
            }),
          on.watchPosition &&
            (on.watchPosition = function watchPosition(
              success,
              error,
              options
            ) {
    ...
    (Wombat.prototype.initStorageOverride = function () {
      this.addEventOverride(
        "storageArea",
        this.$wbwindow.StorageEvent.prototype
      ),
            ...
            orig_databases
              ...
              .then(function (dbList) {
                for (var keys = [], i = 0; i < dbList.length; i++)
                  dbList[i].name.indexOf(prefix) === 0 &&
                    keys.push({
    ...
    (Wombat.prototype.initWindowObjProxy = function ($wbwindow) {
      ...
      var ownProps = this.getAllOwnProps($wbwindow),
        ...
        windowProxy = new $wbwindow.Proxy(
          {},
          {
            get: function (target, prop) {
              // * jingyz: Start change
              function originalWombatWindowGet(target, prop) {
                switch (prop) {
                  case "top":
                  ...
                  case "parent":
                    ...
                    try {
                      var parentProxy =
                        wombat.$wbwindow.parent._WB_wombat_obj_proxy;
                      if (parentProxy) return parentProxy;
                    } catch (e) {}
                    return wombat.$wbwindow.WB_wombat_top._WB_wombat_obj_proxy;
                }
                return wombat.defaultProxyGet(
                  $wbwindow,
                  prop,
                  ownProps,
                  funCache
            ...
            set: function (target, prop, value) {
              switch (prop) {
                case "location":
                  return ($wbwindow.WB_wombat_location = value), true;
                case "postMessage":
                case "document":
                  return true;
              }
            ...
            preventExtensions: function (target) {
              return Object.preventExtensions($wbwindow), true;
            },
            deleteProperty: function (target, prop) {
              ...
              return (
                ...
                (propDescriptor.configurable !== false &&
                  (delete target[prop], delete $wbwindow[prop], true))
              );
            },
            defineProperty: function (target, prop, desc) {
              var ndesc = desc || {};
              return (
                ndesc.value === undefined &&
                  ndesc.get === undefined &&
      ...
      return ($wbwindow._WB_wombat_obj_proxy = windowProxy), windowProxy;
    }),
    (Wombat.prototype.initDocumentObjProxy = function ($document) {
      if ((this.initDocOverrides($document), !this.$wbwindow.Proxy))
        return undefined;
      var funCache = {},
      ...
      return ($document._WB_wombat_obj_proxy = documentProxy), documentProxy;
    }),
    (Wombat.prototype.initAutoFetchWorker = function () {
      if (this.wbUseAFWorker) {
        var af = new AutoFetcher(this, {
          ...
          workerURL:
            (this.wb_info.auto_fetch_worker_prefix ||
              this.wb_info.static_prefix) +
    ...
    (Wombat.prototype.initTopFrameNotify = function (wbinfo) {
      var wombat = this,
        notify_top = function notify_top(event) {
          if (!wombat.$wbwindow.__WB_top_frame) {
            ...
            return void wombat.$wbwindow.location.replace(
              wbinfo.top_url + hash
            );
          }
            ...
            if (
              ...
              for (
                var hicon,
                  icons = [],
                  hicons =
                    wombat.$wbwindow.document.querySelectorAll(
                      "link[rel*='icon']"
                    ),
                  i = 0;
                i < hicons.length;
              ...
              var message = {
                ...
                title: wombat.$wbwindow.document
                  ? wombat.$wbwindow.document.title
                  : "",
      ...
      this.$wbwindow.document.readyState === "complete"
        ? notify_top()
        : this.$wbwindow.addEventListener
        ? this.$wbwindow.document.addEventListener(
            "readystatechange",
            notify_top
          )
        : this.$wbwindow.attachEvent &&
    ...
    (Wombat.prototype.initTopFrame = function ($wbwindow) {
      ...
      for (
        var next_parent = function (win) {
            try {
              return (
                !!win &&
                (win.wbinfo ? win.wbinfo.is_framed : win._wb_wombat != null)
              );
            } catch (e) {
              return false;
            }
          ...
          replay_top = $wbwindow;
        replay_top.parent != replay_top && next_parent(replay_top.parent);
      ...
      if (
        ((real_parent != $wbwindow && this.wb_info.is_framed) ||
    ...
    (Wombat.prototype.initWombatTop = function ($wbwindow) {
      if (Object.defineProperty) {
        var isWindow = function isWindow(obj) {
            return typeof window.constructor === "undefined"
              ? obj instanceof window.constructor
              : obj.window == obj;
          },
          getter = function top() {
            return this.__WB_replay_top
              ? this.__WB_replay_top
              : isWindow(this)
              ? this
              : this.top;
          },
      ...
      var wombat = this,
        ...
        runEval2 = function runEval(func) {
          ...
          return obj && obj.eval && obj.eval !== eval
            ? {
                eval: function () {
                  return obj.eval.__WB_orig_apply(
                    obj,
            ...
            : {
                eval: function (thisObj, args, evalparam) {
                  var isGlobal =
                    thisObj === wombat.proxyToObj(wombat.$wbwindow);
                  try {
    ...
    (Wombat.prototype.wombatInit = function () {
      this._internalInit(),
        ...
        this.overrideFuncArgProxyToObj(
          this.$wbwindow.MutationObserver,
          "observe"
        ),
        this.overrideFuncArgProxyToObj(
          this.$wbwindow.Node,
      ...
      return {
        ...
        local_init: function (name) {
          ...
          return name === "document" && res && !res._WB_wombat_obj_proxy
            ? wombat.initDocumentObjProxy(res) || res
            : res;
        },
    ...
    (window._WBWombatInit = function (wbinfo) {
      ...
      } else this._wb_wombat.init_paths(wbinfo);
    });
})();

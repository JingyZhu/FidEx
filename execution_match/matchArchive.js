...
class ArchiveMatcher {
    ...
    async matchLive2Archive(url, row, col, ts=null) {
        ...
        return {
            ...
            position: archivePos,
            originalText: origJSP.getText(origPath), 
            archiveText: archiveJSP.getText(archivePos.start, archivePos.end)
        };
    }
}
